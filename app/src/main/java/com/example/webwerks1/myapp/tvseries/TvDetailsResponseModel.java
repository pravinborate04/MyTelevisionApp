 ...
 */
public class TvDetailsResponseModel
{
    ...
    private List<CreatedByEntity> created_by;
    ...
    public List<CreatedByEntity> getCreated_by() {
        return created_by;
    }

    public void setCreated_by(List<CreatedByEntity> created_by) {
